...
%% File Path
filePath = '/home/emily/Desktop/petImg/';
fileName = 'img';
...
for frame = st_im+1:NumberOfFrames
    ...
    saveas(figure(1), sprintf('color13/im_%04d.jpg', frame));
    OLDORIGINS(loopCounter, :) = [actualOrigin(1), actualOrigin(2), p(3), p(4)];
    loopCounter=loopCounter+1;
    
    clear negFeat posFeat;
end

dlmwrite('Color13.txt', OLDORIGINS);
